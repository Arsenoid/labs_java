...
public class Laba8_2 {
    ...
    public static void main (String[] args) throws SQLException, IOException {
        ...
        String tablecolumnname = "laba8_2_column";
        int input;
        while (true){
            System.out.println("--------------------------------------------------");
            ...
            System.out.println("4 - Загрузить все данные о гидростанциях по столбцу (долго)");
            System.out.println("5 - вывод по коду поста");
            System.out.println("6 - вывод по коду поста и дате");
            ...
            switch (input){
                ...
                case (3):
                    ...
                    break;
                case (4):
                    helper.importExcelColumnToDatabase("Urovni2_1_1_new_1_2.xlsx",tablecolumnname);
                    break;
                case (5):
